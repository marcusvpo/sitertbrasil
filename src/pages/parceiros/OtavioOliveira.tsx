...
const img = (name: string) =>
  `${SUPABASE_URL}/storage/v1/object/public/parceiros/otavio/${name}`;

const achievements = [
  { year: "Ativo", title: "Guia de Trilhas Off-Road — Ilicínea, MG", category: "Enduro & Trilha", icon: Flag },
  { year: "Ativo", title: "Piloto KTM 350 SX-F #05", category: "Motocross", icon: Bike },
  { year: "Ativo", title: "Especialista em Compra e Revenda Off-Road", category: "Negócios", icon: Award },
  { year: "Ativo", title: "Embaixador RT Brasil em Minas Gerais", category: "Parceria", icon: Shield },
];

const parallaxImages = [
  { src: img("foto1.jpg"), alt: "Otavio Oliveira em ação nas trilhas" },
  { src: img("foto2.jpg"), alt: "Otavio Oliveira pilotando KTM" },
  { src: img("foto3.jpg"), alt: "Otavio Oliveira salto de motocross" },
  { src: img("foto4.jpg"), alt: "Otavio Oliveira nas trilhas de Ilicínea" },
  { src: img("foto5.jpg"), alt: "Otavio Oliveira com produtos MOTOREX" },
];
  ...
  <div className="absolute top-4 left-4 right-4 z-30 hidden md:flex justify-between items-start pointer-events-none">
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2 bg-secondary/60 backdrop-blur-md border border-primary/20 rounded px-3 py-1.5">
        ...
        <span className="font-heading text-[10px] uppercase tracking-[0.15em] text-secondary-foreground/40">MX · KTM 350</span>
      </div>
    </div>
          ...
          <AnimateOnScroll animation="fade-up">
            <div className="flex flex-col md:flex-row items-center md:items-center gap-2 md:gap-3 mb-4 md:justify-end">
              ...
              <span className="bg-primary/10 border border-primary/30 text-primary text-[10px] font-heading uppercase tracking-wider px-2.5 py-1.5 rounded flex items-center gap-1.5 min-h-[44px]">
                <Shield className="w-3 h-3" /> Guia Off-Road
              </span>
              <a
                href="https://instagram.com/otaviooliveira05"
                target="_blank"
              ...
              >
                <Instagram className="w-3.5 h-3.5" /> @otaviooliveira05
              </a>
            </div>
            ...
            <h1 className="font-heading text-[36px] md:text-[100px] lg:text-[130px] uppercase font-bold leading-[0.85] mb-4 md:mb-6">
              Otavio
              <br />
              <span className="text-gradient drop-shadow-[0_0_40px_hsl(197_100%_43.7%/0.3)]">Oliveira</span>
            </h1>

            <p className="text-secondary-foreground/60 text-base md:text-xl max-w-xl leading-relaxed md:ml-auto">
              Piloto <strong className="text-secondary-foreground">KTM 350 SX-F #05</strong>, guia de trilhas em Ilicínea-MG
              e especialista em motos off-road. A força mineira no universo das trilhas.
            </p>
          </AnimateOnScroll>
        </div>
          ...
          <AnimateOnScroll animation="fade-up" delay={200}>
            <div className="liquid-glass rounded-lg p-4 md:p-8 lg:p-12 relative overflow-hidden">
              ...
              <div className="relative grid grid-cols-2 md:grid-cols-4 gap-8">
                <Counter target="05" label="Número" icon={Bike} />
                <Counter target="🏍️" label="KTM 350" icon={Gauge} />
                <Counter target="🗺️" label="Guia Trilhas" icon={Flag} />
                <Counter target="MG" label="Ilicínea" icon={Target} />
              </div>
            </div>
          </AnimateOnScroll>
        </div>
          ...
          <AnimateOnScroll animation="scale-in">
            <div className="relative inline-block">
              ...
              <div className="mt-4 flex items-center justify-center gap-3">
                ...
                <span className="text-primary/60 text-xs font-heading uppercase tracking-[0.3em]">Ilicínea MG</span>
                <div className="h-[1px] w-20 bg-primary/30" />
                <Flag className="w-4 h-4 text-primary/50" />
              </div>
            </div>
        ...
        <div className="container text-center py-20 relative">
          ...
          <AnimateOnScroll animation="fade-up">
            ...
            <h2 className="font-heading text-[36px] md:text-[56px] uppercase font-bold leading-none mb-4">
              Paixão & <span className="text-gradient">Off-Road</span>
            </h2>
            <p className="text-secondary-foreground/50 max-w-md mx-auto">
              Das trilhas de Ilicínea às pistas de motocross, Otavio vive e respira o mundo off-road todos os dias.
            </p>
            ...
            <AnimateOnScroll animation="fade-in-left" className="md:col-span-2">
              <div className="relative rounded-lg overflow-hidden aspect-[3/4] group">
                ...
                <div className="absolute top-5 left-5 bg-secondary/70 backdrop-blur-md border border-primary/20 rounded px-3 py-1.5 flex items-center gap-2">
                  <Crown className="w-3.5 h-3.5 text-primary" />
                  <span className="font-heading text-[10px] uppercase tracking-[0.2em] text-primary">Trail Boss</span>
                </div>
            ...
            <AnimateOnScroll animation="fade-in-right" className="md:col-span-3">
              <div>
                ...
                <h2 className="font-heading text-[36px] md:text-[48px] uppercase font-bold leading-none mb-6">
                  Quem é <span className="text-gradient">Otavio</span>
                </h2>

                {/* Stat bars */}
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {[
                    { label: "Velocidade", value: 82, icon: Gauge },
                    { label: "Técnica", value: 88, icon: Target },
                    { label: "Resistência", value: 90, icon: Shield },
                    { label: "Coragem", value: 94, icon: Flame },
                  ].map((stat) => (
                ...
                <div className="space-y-4 text-secondary-foreground/60 leading-relaxed text-base md:text-lg">
                  <p>
                    Natural de <strong className="text-secondary-foreground">Ilicínea, Minas Gerais</strong>,
                    Otavio Oliveira é um apaixonado pelo mundo off-road que transformou essa paixão em estilo de vida.
                    Pilotando sua <strong className="text-primary">KTM 350 SX-F #05</strong>, Otavio é referência
                    nas trilhas da região do interior mineiro.
                  </p>
                  <p>
                    Além de piloto, Otavio atua como <strong className="text-primary">guia de trilhas em Ilicínea</strong>,
                    levando grupos por roteiros off-road que exploram o melhor do terreno mineiro — serras, matas
                    e caminhos que testam a habilidade de qualquer piloto. Seu conhecimento profundo do terreno
                    e sua experiência na pilotagem fazem dele o parceiro ideal para aventuras off-road.
                  </p>
                  <p>
                    Otavio também atua na <strong className="text-primary">compra e revenda de motos off-road</strong>,
                    conectando entusiastas com as melhores máquinas do mercado. Com a confiança da RT Brasil
                    e os produtos MOTOREX, Otavio garante que cada moto que passa por suas mãos
                    esteja equipada com o que há de melhor em lubrificação e cuidados.
                  </p>
                </div>
          ...
          <AnimateOnScroll animation="scale-in">
            <div className="relative inline-block">
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                ...
                <span className="text-primary/60 text-xs font-heading uppercase tracking-[0.3em]">Full Send</span>
          ...
          <AnimateOnScroll animation="scale-in">
            <div className="relative inline-block">
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                ...
                <span className="text-primary/60 text-xs font-heading uppercase tracking-[0.3em]">Desbravador</span>
                <Star className="w-4 h-4 text-primary/50" />
              </div>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="fade-up">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-secondary-foreground/60 text-base md:text-lg leading-relaxed mb-4">
                Otavio confia na tecnologia suíça MOTOREX para manter sua KTM 350 SX-F sempre no ponto. Seja nas trilhas de Ilicínea ou nas pistas de motocross, a MOTOREX entrega performance e proteção.
              </p>
              <p className="text-secondary-foreground/50 text-sm md:text-base leading-relaxed mb-8">
                Para quem vive o off-road no dia a dia — pilotando, guiando grupos e cuidando de motos — a qualidade dos produtos faz toda a diferença. A linha MOTOREX garante durabilidade e rendimento em qualquer condição de terreno.
              </p>
            ...
            <div className="liquid-glass rounded-lg p-6 md:p-10 lg:p-16 text-center max-w-3xl mx-auto relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <h2 className="font-heading text-[28px] md:text-[44px] uppercase font-bold leading-none mb-4">
                  ...
                  <span className="text-gradient">Otavio</span>
                </h2>
                <p className="text-secondary-foreground/50 mb-8 max-w-md mx-auto text-base md:text-lg">
                  Conheça a linha MOTOREX escolhida por pilotos e guias off-road como o Otavio Oliveira.
                </p>
                <Link to="/motorex">
